        ...
        val voiceSystem: ChatMessage = ChatMessage(
            ...
            content =
                "You are Mythara — a personal field intelligence agent. " +
                    ...
                    "    For interactive renders with state (counters, forms, mini-games), use template='preact-tailwind' — `mythara.html`, `mythara.render`, `mythara.useState`, `mythara.useEffect` are pre-loaded. Mount into `<div id=\"root\"></div>` from a <script> tag using the htm tagged template literal (JSX without a build step).\n" +
